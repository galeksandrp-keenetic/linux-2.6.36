...
#if/*CONFIG_TCSUPPORT_COMPILE*/ defined(CONFIG_TCSUPPORT_BOOTLOADER_MODIFY_PVNAME)
...
#endif/*CONFIG_TCSUPPORT_COMPILE*/
...
#if defined(CONFIG_TCSUPPORT_CMDPROMPT)
int print_usage=0;
int print_state=0;
...
#if/*CONFIG_TCSUPPORT_COMPILE*/ defined(CONFIG_TCSUPPORT_BTN_CHECK)
...
#endif/*CONFIG_TCSUPPORT_COMPILE*/
#endif
#if/*CONFIG_TCSUPPORT_COMPILE*/ defined(CONFIG_TCSUPPORT_C1_NEW_GUI)
int doRomReset(int argc, char *argv[], void *p);
#endif/*CONFIG_TCSUPPORT_COMPILE*/
#if defined(CONFIG_TCSUPPORT_USBHOST)
int doUSBEYE(int argc, char *argv[], void *p);
#endif
#if/*CONFIG_TCSUPPORT_COMPILE*/ defined(CONFIG_TCSUPPORT_C2_TRUE)
int doRomCheck(int argc, char *argv[], void *p);
#endif/*CONFIG_TCSUPPORT_COMPILE*/
#if/*CONFIG_TCSUPPORT_COMPILE*/ defined(CONFIG_TCSUPPORT_C1_OBM)
