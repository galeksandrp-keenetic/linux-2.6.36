...
#define isMT7520	(((regRead32(0xbfb000f8)&0x3)==0x2) && isMT751020 && (isENP_MOD))
#define isMT7520G	(((regRead32(0xbfb000f8)&0x3)==0x3) && isMT751020 && (isENP_MOD))
#define isMT7525	(((regRead32(0xbfb000f8)&0x3)==0x2) && isMT751020 && (!isENP_MOD))
#define isMT7525G	(((regRead32(0xbfb000f8)&0x3)==0x3) && isMT751020 && (!isENP_MOD))
#define isMT7520S       (((regRead32(0xbfb000f8)&0x3)==0x2) && isMT751020 && (isENP_MOD) && (isENS_MOD))
#define isFPGA          ((regRead32(CR_AHB_HWCONF)&(1<<31)) ? 1 : 0) //used for 63365/751020
#ifdef CONFIG_TCSUPPORT_MT7510_E1
...
#define	SYS_HCLK		(isMT751020 ? MT751020_SYS_HCLK : (isRT63365 ? RT63365_SYS_HCLK : (isRT63165 ? RT63165_SYS_HCLK : (isRT65168 ? (1024/10) : (isTC3182 ? (1024/10) : (3*((regRead32(0xbfb00058)>>16)+1)/(((regRead32(0xbfb00058)&0x1f)+1)<<1)))))))
#endif

#define	SAR_CLK	(SYS_HCLK)/(4.0)		//more accurate if 4.0 not 4

/* define CPU timer clock, FPGA is 50Mhz, ASIC is 250Mhz */
#define	CPUTMR_CLK		(regRead32(0xbfb0008c)&(1<<31) ? 50	: isMT751020 ? 266 :250)
...
#ifdef CONFIG_TCSUPPORT_GPIO_ECM
...
#if 0
#define CONFIG_TCSUPPORT_CPU_MT7510_FAKE

#ifdef CONFIG_TCSUPPORT_CPU_MT7510
#undef DEFAULT_USE_EXT_SWIC
#endif
#ifdef CONFIG_TCSUPPORT_CPU_MT7520
#define DEFAULT_USE_EXT_SWIC
#endif
#if defined(CONFIG_TCSUPPORT_CPU_RT65168) || defined(CONFIG_TCSUPPORT_CPU_TC3182)	// for early MT7530 FPGA verification only
#define DEFAULT_USE_EXT_SWIC
#endif

#if defined(CONFIG_TCSUPPORT_CPU_MT7510) || defined(CONFIG_TCSUPPORT_CPU_MT7520) || defined(CONFIG_TCSUPPORT_CPU_MT7520E) || defined(CONFIG_TCSUPPORT_CPU_MT751x20G25G) || defined(CONFIG_TCSUPPORT_CPU_MT7511G) || defined(CONFIG_TCSUPPORT_CPU_MT752025)
